...
public class PlatformAccountPhoneCheckFragment extends BaseFragment {
    ...
    public static PlatformAccountPhoneCheckFragment newInstance(int opt_code) {
        PlatformAccountPhoneCheckFragment fragment = new PlatformAccountPhoneCheckFragment();
    ...
    @OnClick({R.id.btn_next, R.id.tv_protocol})
