 ...
 * https://github.com/chenyuantao/AndroidWaveView
 */
public class WaveView extends View {
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      mPath.quadTo(mControlPoints[i].x + increment, mControlPoints[i].y,
          mStartPoints[i].x + mViewWidth + increment, mStartPoints[i].y);
    }
