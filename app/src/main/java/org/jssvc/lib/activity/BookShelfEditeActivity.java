...
public class BookShelfEditeActivity extends BaseActivity {
  ...
  @OnClick({ R.id.tvBack, R.id.ivAdd }) public void onClick(View view) {
    switch (view.getId()) {
      case R.id.tvBack:
        onBackPressed();
        break;
  ...
  private void parseHtml2List(String s) {
    ...
    bookShelfEditeAdapter.setOnItemClickListener(new BookShelfEditeAdapter.IMyViewHolderClicks() {
      @Override public void onItemClick(View view, BookShelfBean item) {
      }
      ...
      @Override public void onDeleteClick(View view, BookShelfBean item) {
        // 删除书架
