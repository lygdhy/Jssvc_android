...
public class BookReadingAdapter extends RecyclerView.Adapter<BookReadingAdapter.ViewHolder> implements View.OnClickListener {
    Context context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_book_reading, parent, false);
