...
public class BookShelfEditeAdapter extends RecyclerView.Adapter<BookShelfEditeAdapter.ViewHolder> implements View.OnClickListener {
    Context context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_book_shelf_edite, parent, false);
