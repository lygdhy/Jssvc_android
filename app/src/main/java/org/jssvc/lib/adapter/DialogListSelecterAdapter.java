...
public class DialogListSelecterAdapter extends RecyclerView.Adapter<DialogListSelecterAdapter.ViewHolder> implements View.OnClickListener {
    Context context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.dialog_item_select_layout, parent, false);
