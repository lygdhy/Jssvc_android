...
public class BookSearchHisAdapter extends RecyclerView.Adapter<BookSearchHisAdapter.ViewHolder> implements View.OnClickListener {
    Context context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_book_search_his, parent, false);
